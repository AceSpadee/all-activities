...
// h4tags[0].setAttribute('style', 'color:blue; font-size: 30px; padding-left: 10px; margin: 0')
// h4tags[1].setAttribute('style', 'color:blue; font-size: 30px; padding-left: 10px; margin: 0')
// h4tags[2].setAttribute('style', 'color:blue; font-size: 30px; padding-left: 10px; margin: 0')


//h4tags.children[0].setAttribute('style', 'color:blue; font-size: 30px');

for (let i = 0; i < h4tags.length; i++) {
  h4tags[i].setAttribute('style', 'color: blue; font-size: 30px; padding-left: 10px; margin: 0');
}