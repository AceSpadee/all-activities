...
// it is taking the originalarray and trippling the data.           the value would be 3 , 9, 6, 15, 30 (integer)


// TODO: Describe how map is working in the example below. What will the value of oddOrEven be?
// it is mapping the originalarray and replacing the number with even or odd.      the value would be odd, odd, even, odd, even, (string)
